...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseStart: function(event) {
		...
		(o.cursorAt && this._adjustOffsetFromHelper(Object(o.cursorAt)));
	...
	_createHelper: function(event) {
		var o = this.options;
		var helper = $.isFunction(o.helper) ? jQuery(o.helper.apply(this.element[0], [event])) : (o.helper == 'clone' ? this.element.clone() : this.element);
...
$.ui.plugin.add("draggable", "stack", {
	start: function(event, ui) {
		...
		var group = $.makeArray(jQuery(o.stack)).sort(function(a,b) {
	...
	mopSlider:function(stt){
		...
		var mopSldSrc=function(mopSldTyp){
			if(mopSldTyp=="paper"){
				...
				btnLeft.src=imagePaths+"sliderBtnLtW.png";
				btnLeftF.src=imagePaths+"sliderBtnLtW_f.png";
				btnRight.src=imagePaths+"sliderBtnRtW.png";
				btnRightF.src=imagePaths+"sliderBtnRtW_f.png";
				//btnCenter.src=imagePaths+"sliderBtnW.png";
				btnCenter.src=imagePaths+"sliderBtnW.png";
				btnChange.src=imagePaths+"sliderBkRtRtW.png";
				btnChangeNn.src=imagePaths+"sliderBkRtRtNnW.png";
				btnChangeF.src=imagePaths+"sliderBkRtRtW_f.png";
				bkImg.src=imagePaths+"paperBk.gif";
				sldcLeftImg.src=imagePaths+"sliderBkLtLtW.png";
				sldBkLeft.src=imagePaths+"sliderBkLtW.png";
				sldBkCenter.src=imagePaths+"sliderBkW.png";
				sldBkRight.src=imagePaths+"sliderBkRtW.png";				
				...
				btnLeft.src=imagePaths+"sliderBtnLt.png";
				btnLeftF.src=imagePaths+"sliderBtnLt_f.png";
				btnRight.src=imagePaths+"sliderBtnRt.png";
				btnRightF.src=imagePaths+"sliderBtnRt_f.png";
				btnCenter.src=imagePaths+"sliderBtn.png";
				btnChange.src=imagePaths+"sliderBkRtRt.png";
				btnChangeNn.src=imagePaths+"sliderBkRtRtNn.png";
				btnChangeF.src=imagePaths+"sliderBkRtRt_f.png";
				bkImg.src=imagePaths+"monoBk.gif";
				sldcLeftImg.src=imagePaths+"sliderBkLtLt.png";
				sldBkLeft.src=imagePaths+"sliderBkLt.png";
				sldBkCenter.src=imagePaths+"sliderBk.png";
				sldBkRight.src=imagePaths+"sliderBkRt.png";				
			}
		}
		mopSldSrc(mopSldTyp);
		...
		jQuery(mpSldNm).hide();
		var arr=jQuery.makeArray(jQuery(this).children());
		...
		jQuery(this).css({position:"absolute",overflow: "hidden",left: "0px",display: "block"});
		itemNum=jQuery(this).children().length;
		itemNumS.push(itemNum);
		var allW=0;
		var num=0;
		for (i=1; i<(itemNum+1); i++){
			var itemW=eval(jQuery(this).children().eq(num).css("width").split("px")[0]);
			nextMov.push(itemW);
			var itemH=eval(jQuery(this).children().eq(num).css("height").split("px")[0]);
			var mgn=(mopSldH-itemH)/2;
			//jQuery(this).children().eq(num).css({marginTop:mgn+px});
			num+=1;
			allW+=itemW;
		};
		...
		jQuery(this).wrap('<div id="mopSlider"><div id="'+noSharp+'"><div class="holder"></div></div></div>');
		...
		jQuery(mpSldNm+" .sliderCase").css({position:"relative",top:"0px"});//height:"22px",
		jQuery(mpSldNm+" .sliderCaseLeft").css({height:"22px",width:"25px",position:"absolute",top:"0px",left:"0px",backgroundImage:"url("+sldcLeftImg.src+")",backgroundRepeat:"no-repeat"});
		if((auto=="nn")||(auto=="yn")){
			jQuery(mpSldNm+" .sliderCaseRight").css({height:"22px",width:"25px",position:"absolute",top:"0px",right:"0px",backgroundImage:"url("+btnChangeNn.src+")",cursor:"",backgroundRepeat:"no-repeat"});
		}else{
			jQuery(mpSldNm+" .sliderCaseRight").css({height:"22px",width:"25px",position:"absolute",top:"0px",right:"0px",backgroundImage:"url("+btnChange.src+")",cursor:"pointer",backgroundRepeat:"no-repeat"});
		}
		jQuery(mpSldNm+" .slider").css({height:"22px",position:"relative",top:"0px"});//,left:"25px"
		jQuery(mpSldNm+" .sldLeft").css({left:"0px",position:"absolute",height:"22px",width:"20px",backgroundImage:"url("+sldBkLeft.src+")",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .sldCenter").css({left:"20px",width:sldW-40+px,position:"absolute",height:"22px",backgroundImage:"url("+sldBkCenter.src+")",backgroundRepeat:"repeat-x"});
		jQuery(mpSldNm+" .sldRight").css({right:"0px",position:"absolute",height:"22px",width:"20px",backgroundImage:"url("+sldBkRight.src+")",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .sliderBtn").css({position:"absolute",height:"22px",left:"0px",cursor:"default"});
		jQuery(mpSldNm+" .sldBtnLeft").css({left:"0px",position:"absolute",height:"22px",width:"20px",backgroundImage:"url("+btnLeft.src+")",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .sldBtnCenter").css({left:"20px",width:btnW-40+px,position:"absolute",height:"22px",backgroundImage:"url("+btnCenter.src+")",backgroundRepeat:"repeat-x"});
		jQuery(mpSldNm+" .sldBtnRight").css({right:"0px",position:"absolute",height:"22px",width:"20px",backgroundImage:"url("+btnRight.src+")",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .indi").css({paddingTop:"5px",fontSize: "10px",textAlign:"center",fontFamily:"Arial, Helvetica, sans-serif",letterSpacing:"0.05em",color:"#2b313e"});
		jQuery(mpSldNm).css({width:mopSldW+px,height:mopSldH+28+px});
		jQuery(mpSldNm).css({position:"relative",overflow:"hidden",margin:"0 auto 0 auto",backgroundImage:"url("+bkImg.src+")"});
		if(mopSldTyp=="black"){
			jQuery(mpSldNm).css({backgroundColor:"#484848",backgroundRepeat:"repeat-x",backgroundPosition:"bottom"});
		}
		jQuery(mpSldNm+" .leftTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",left:"0px"});
		jQuery(mpSldNm+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(mopSlider/sliderCrnLtTp.png)",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
		jQuery(mpSldNm+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(mopSlider/sliderCrnRtTp.png)",backgroundRepeat:"no-repeat"});
		jQuery(mpSldNm+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
		jQuery(mpSldNm+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(mopSlider/sliderCrnLtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
		jQuery(mpSldNm+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
		jQuery(mpSldNm+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(mopSlider/sliderCrnRtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
		jQuery(mpSldNm+" .logo").css({height:"50px",width:"80px",position:"absolute",top:"0px",left:"0px"});
		jQuery(mpSldNm+" .logoIn").css({height:"50px",width:"80px",backgroundImage:"url(mopSlider/logo.png)",backgroundRepeat:"no-repeat"});
		if(os=="mac"){jQuery(mpSldNm+" .indi").css({letterSpacing:"0.1em"})};/*foe mac*/
		sclMax=boxW-mopSldW;
		...
		jQuery(mpSldNm+" .holder").css({width:holderWidth+"px",height:mopSldH+px,position:"relative",left:-(sclMax)+px,cursor:'default'});
		jQuery(mpSldNm+" .holder").children().css({width:boxW+px,left:sclMax+px});
		jQuery(mpSldNm+" .holder").children().children().css({marginLeft:itemMgn+"px",float:"left",position:"relative"});
		jQuery(mpSldNm+" .sliderCase").css({width:sldW+px});//jQuery(mpSldNm+" .sliderCase").css({width:sldW+50+px});
		var sldCaseW=eval(jQuery(mpSldNm+" .sliderCase").css("width").split("px")[0]);
		var sliderLeftMgn=(mopSldW-sldCaseW)/2;
		jQuery(mpSldNm+" .sliderCase").css({left:sliderLeftMgn+px});
		jQuery(mpSldNm+" .slider").css({width:sldW+px});
		jQuery(mpSldNm+" .sliderBtn").css({width:btnW+px});
		/*jQuery(this).pngFix();
		jQuery(mpSldNm+" .sliderCase,"+mpSldNm+" .leftTop,"+mpSldNm+" .rightTop").pngFix();
		jQuery(mpSldNm+" .leftBottom,"+mpSldNm+" .rightBottom,"+mpSldNm+" .logo").pngFix();*/
		jQuery(mpSldNm+" .indi").html(indication);
		...
		moveS.push(move);
		jQuery(mpSldNm).show();
		jQuery(mpSldNm+" .sliderBtn").draggable({
			axis:"x",
			containment:"parent",
			start:function(){
		...
		jQuery(mpSldNm+" .holder").children().draggable({
			axis:"x",
			containment:"parent",
			start:function(){
				for (i=1; i<(mpSldNoS.length+1); i++){
		...
		jQuery("#mopSlider .sliderBtn").mousedown(
			function(){
				clearInterval(timeCheck1);
				clearInterval(finalTime1);
			}
		);
		jQuery("#mopSlider .holder").children().mousedown(
			function(){
				clearInterval(timeCheck1);
				clearInterval(finalTime1);
			}
		...
		var movCheck=function(mpSldNo,mpSldNm){
			var j=mpSldNo-1;
			sldNum=sldNumS[j];
			var boxPosiPx=jQuery(mpSldNm+" .holder").children().css("left");
			...
			jQuery(mpSldNm+" .sliderBtn").css({left:-(boxNum*sldNumS[j])+px});
		}
		...
		mpSldF={
			dragCheckItv:function(mpSldNo,mpSldNm){
				...
				var boxNum;
				var j=mpSldNo-1;
				btnPosiS[j]=eval(jQuery(mpSldNm+" .sliderBtn").css("left").split("px")[0]);
				boxPosiS[j]=eval(jQuery(mpSldNm+" .holder").children().css("left").split("px")[0]);
				sldNum100=btnPosiS[j]/sldNumS[j];
				boxPosi0=-(boxPosiS[j]-sclMaxS[j]);
				boxNum=-(boxPosi0/sclNumS[j]);
				if(wchDgS[j]=="btn"){
					jQuery(mpSldNm+" .holder").children().css({left:Math.floor(-(sldNum100*sclNumS[j])+sclMaxS[j])+px});
				}else if(wchDgS[j]=="holder"){
					jQuery(mpSldNm+" .sliderBtn").css({left:-(boxNum*sldNumS[j])+px});
				};
				jQuery(".mopCheck").html(boxNum+" "+sldNum100);
			},
			move:function(mpSldNo,mpSldNm){
				...
				if(animS[j]=="y"){
					if(turnS[j]=="go"){
						...
						jQuery(mpSldNm+" .holder").children().animate({left:-posiS[j]+sclMaxS[j]+px},
						...
						jQuery(mpSldNm+" .holder").children().animate({left:posiBkS[j]+px},
							{duration:moveS[j],easing:'swing',
								step:function(){movCheck(mpSldNo,mpSldNm)},
								complete:function(){
									if(itemNumS[j]!=1){
			...
			manualAct:function(mpSldNo,mpSldNm,mopSldTyp){
				jQuery(mpSldNm+" .holder").children().stop();
				var j=mpSldNo-1;
				clearInterval(mpSldMoS[j]);
				animS[j]='n'
				jQuery(mpSldNm+" .indi").html(indiS[j]);
				if(autoS[j]!='yn'){
					mopSldSrc(mopSldTyp);
					if(browser!="ie6"){
						jQuery(mpSldNm+" .sldBtnLeft").css({backgroundImage:"url("+btnLeft.src+")"});
						jQuery(mpSldNm+" .sldBtnRight").css({backgroundImage:"url("+btnRight.src+")"});
						jQuery(mpSldNm+" .sliderCaseRight").css({backgroundImage:"url("+btnChange.src+")"});
					}
				}
				jQuery(mpSldNm+" .holder").children().css({cursor:"move"});
			},
			autoAct:function(mpSldNo,mpSldNm,mopSldTyp,chkNum,chkNumBk){
				...
				if(eval(jQuery(mpSldNm+" .sliderBtn").css("left").split("px")[0])<10){
					moveSS=100;
				}else{
					moveSS=moveS[j]
				}
				jQuery(mpSldNm+" .holder").children().animate({left:sclMax+px},
			...
			auto:function(mpSldNo,mpSldNm,mopSldTyp){
				mopSldSrc(mopSldTyp);
				jQuery(mpSldNm+" .indi").html("Auto");
				var j=mpSldNo-1;
				if(autoS[j]!="yn"){
					if(browser!="ie6"){
						jQuery(mpSldNm+" .sldBtnLeft").css({backgroundImage:"url("+btnLeftF.src+")"});
						jQuery(mpSldNm+" .sldBtnRight").css({backgroundImage:"url("+btnRightF.src+")"});
						jQuery(mpSldNm+" .sliderCaseRight").css({backgroundImage:"url("+btnChangeF.src+")"});
					}
				}
			},
			...
			finalTimeItv:function(mpSldNo,mpSldNm){
				...
				btnPosiS[j]=eval(jQuery(mpSldNmTemp+" .sliderBtn").css("left").split("px")[0]);
				boxPosiS[j]=eval(jQuery(mpSldNmTemp+" .holder").children().css("left").split("px")[0]);
				if(wchDgS[j]=="btn"){
					...
					jQuery(mpSldNmTemp+" .sliderBtn").css({left:btnMoveTo+px});
					...
					jQuery(mpSldNmTemp+" .holder").children().css({left:boxMoveTo+px});
					/*set boxPast*/
		...
		/*end mpSldF*/
		jQuery(mpSldNm+" .sliderCaseRight").click(
			function(){
				for (i=1; i<(mpSldNoS.length+1); i++){
					var j=i-1;
					if(mpSldNo==i){
		...
		jQuery(mpSldNm+" .holder").children().mousedown(function(){clickToManual();});
		jQuery(mpSldNm+" .sliderBtn").mousedown(function(){clickToManual();});
